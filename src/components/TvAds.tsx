...
export default function TvAds() {
  return (
    // <section id="tv-ads" className="overflow-hidden bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-10">
        <div className="mb-12 grid items-end gap-6 md:grid-cols-[1fr_auto]">
          <div className="animate-fadeInUp">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-red-50 px-4 py-2 text-sm font-semibold text-red-600 ring-1 ring-red-100">
          ...
          <div className="flex w-full max-w-sm items-center gap-3 rounded-lg border border-gray-200 bg-white p-4 text-gray-700 shadow-sm md:w-80">
            <RadioTower className="h-8 w-8 shrink-0 text-blue-600" />
            <p className="text-sm">
          ...
          {tvAds.map((ad, index) => (
            ...
            >
              <div className="relative mx-auto max-w-xl">
                ...
                <div className="mx-auto h-6 w-20 bg-gradient-to-b from-slate-800 via-slate-950 to-black shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]" />
                <div className="mx-auto h-3 w-52 rounded-t-2xl bg-gradient-to-r from-gray-950 via-slate-700 to-gray-950 shadow-[0_10px_22px_rgba(15,23,42,0.22)]" />
              </div>
